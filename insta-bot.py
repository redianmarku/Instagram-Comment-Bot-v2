...
def setting_ui():
    ...
    Label(setting_root, text="NUMBER OF POST TO COMMENT",
          width=25).grid(row=4, column=0)
    Label(setting_root, text="CHANCE TO COMMENT",
          width=25).grid(row=5, column=0)
    Label(setting_root, text="WAIT BETWEEN POSTS (MIN)",
          width=25).grid(row=6, column=0)
    Label(setting_root, text="WAIT BETWEEN POSTS (MAX)",
          width=25).grid(row=7, column=0)
    Label(setting_root, text="WAIT TO COMMENT (MIN)",
          width=25).grid(row=8, column=0)
    Label(setting_root, text="WAIT TO COMMENT (MAX)",
          width=25).grid(row=9, column=0)
    Label(setting_root, text="DO YOU WANT TO LIKE",
          width=25).grid(row=10, column=0)

    username_f = insert_entry(
        setting_root, setting["credentials"]['username'], 0, 1)
    password_f = insert_entry(
    ...
    wait_p1_f = insert_entry(
        setting_root, setting["wait_between_posts"]["min"], 6, 1)
    wait_p2_f = insert_entry(
        setting_root, setting["wait_between_posts"]["max"], 7, 1)
    wait_c1_f = insert_entry(
        setting_root, setting["wait_to_comment"]["min"], 8, 1)
    wait_c2_f = insert_entry(
        setting_root, setting["wait_to_comment"]["max"], 9, 1)
